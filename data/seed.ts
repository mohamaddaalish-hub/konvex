...
const familyGallery = (categoryId: string): Product["images"] => {
  switch (categoryId) {
    case "laser-distance-meters":
      return [
        {
          url: "/images/laser.webp",
          alt: "متر لیزری کانوکس با نمایشگر دیجیتال، کلیدهای کارکرد و پنجره نوری دوتایی در تصویر استودیویی",
        },
        {
          url: "/images/measurement.webp",
          alt: "استفاده از متر لیزری کانوکس برای اندازه‌گیری فاصله در فضای ساختمانی",
        },
        {
          url: "/images/accessories.webp",
          alt: "کیف زیپ‌دار و بند حمل نایلونی متر لیزری کانوکس",
        },
      ];
    case "concrete-chisels":
      return [
        {
          url: "/images/chisels.webp",
          alt: "سه قلم بتن‌کن کانوکس با شکل نوک‌تیز، تخت و پهن در تصویر استودیویی",
        },
        {
          url: "/images/hero.webp",
          alt: "قلم‌های بتن‌کن کانوکس در کنار تراز، متر لیزری و صفحه سایش روی سطح بتن",
        },
      ];
    case "industrial-casters":
      return [
        {
          url: "/images/caster.webp",
          alt: "چرخ صنعتی با رویه پلی‌یورتان، صفحه نصب چهارپیچ و اهرم قفل روی پایه گردان",
        },
        {
          url: "/images/hero.webp",
          alt: "چرخ صنعتی کانوکس در مجموعه ابزار اندازه‌گیری و تخریب روی سطح بتن",
        },
      ];
    case "spirit-levels":
      return [
        {
          url: "/images/level.webp",
          alt: "تراز جعبه‌ای کانوکس با سه محفظه حباب، بدنه آلومینیومی و ضربه‌گیر انتهایی",
        },
        {
          url: "/images/hero.webp",
          alt: "تراز کانوکس در کنار سایر ابزارهای اندازه‌گیری و تخریب روی سطح بتن",
        },
      ];
    case "abrasives":
      return [
        {
          url: "/images/abrasives.webp",
          alt: "صفحات سایش الیافی کانوکس با سوراخ مرکزی و نشان کانوکس روی صفحه",
        },
        {
          url: "/images/workshop.webp",
          alt: "کاربرد صفحات سایش در کارگاه برای برش و پرداخت سطوح",
        },
      ];
    default:
      return [
        {
          url: "/images/accessories.webp",
          alt: "کیف زیپ‌دار پارچه‌ای و بند نایلونی متعلقات متر لیزری کانوکس",
        },
      ];
  }
};
const base = (
  ...
  return {
    ...
    applications: [],
    features: [],
    images: familyGallery(categoryId),
    videos: [],
    documents: [],
    manuals: [],
    warranty:
...
const lasers = laserRanges.map((range, i) =>
  base("laser-distance-meters", i + 1, {
    ...
    longDescription:
      "برای برآورد دقیق‌تر فضا و کاهش رفت‌وآمدهای اندازه‌گیری، یک متر لیزری با برد متناسب با پروژه انتخاب کنید. بدنه عکس‌برداری‌شده نمایشگر دیجیتال، کلیدهای کارکرد و پنجره نوری دوتایی را نشان می‌دهد؛ قرائت روی نمایشگر اندازه‌گیری نمونه است، نه تأیید برد اسمی. این مدل نمونه، اندازه‌گیری فاصله و محاسبه مساحت و حجم را در بدنه‌ای جمع‌وجور معرفی می‌کند. برد اسمی در شرایط مناسب سطح و نور تعریف می‌شود؛ برای فضای بیرونی و سطوح بازتابنده، شرایط اندازه‌گیری را جداگانه بررسی کنید.",
    specifications: [
    ...
    features: [
      ...
      "پنجره نوری دوتایی در جلوی بدنه",
      "نمایشگر دیجیتال با تفکیک میلی‌متر",
    ],
    ...
    faq: [
      ...
      {
        question: "آیا عدد روی نمایشگر همان برد اسمی است؟",
        answer:
          "خیر. قرائت نمایشگر یک اندازه‌گیری در لحظه عکس‌برداری است. برد اسمی در شرایط آزمون مشخص تعریف می‌شود و باید از سند رسمی محصول خوانده شود.",
      },
    ],
  }),
);
...
const chisels = chiselData.map(([type, length, shank, diameter], i) =>
  base("concrete-chisels", i + 1, {
    ...
    longDescription:
      "شکل نوک قلم و نوع اتصال باید با کار و دستگاه بتن‌کن هماهنگ باشند. تصویر خانواده سه شکل نوک را نشان می‌دهد؛ نوع اتصال هر مدل را از جدول مشخصات همان صفحه بخوانید، نه از شباهت ظاهری عکس. مدل نوک‌تیز برای تمرکز نیرو، مدل تخت برای برداشت موضعی و مدل شیارزن برای ایجاد مسیر کاربرد دارند. SDS-Plus و SDS-Max به‌جای یکدیگر نصب نمی‌شوند. جنس بتن، توان دستگاه و شرایط کار را پیش از انتخاب بررسی کنید. مشخصات این صفحه نمونه‌اند و جایگزین دستورالعمل سازنده نیستند.",
    specifications: [
    ...
    features: [
      ...
      "سه شکل نوک در تصویر خانواده: نوک‌تیز، تخت و پهن",
    ],
    ...
    faq: [
      ...
      {
        question: "SDS Plus و SDS Max چه فرقی دارند؟",
        answer:
          "SDS-Plus و SDS-Max اتصال‌های متفاوت‌اند و به‌جای یکدیگر نصب نمی‌شوند. مدل دقیق ابزارگیر دستگاه را از دفترچه آن بخوانید و با مشخصات قلم همین صفحه تطبیق دهید.",
      },
    ],
  }),
);
...
const casters = casterData.map(
  ([diameter, capacity, type, brake, material], i) =>
    base("industrial-casters", i + 1, {
      ...
      longDescription:
        "برای انتخاب چرخ صنعتی، فقط وزن تجهیز کافی نیست. چرخ عکس‌برداری‌شده صفحه چهارپیچ، رویه پلی‌یورتان و اهرم قفل روی پایه گردان دارد؛ جنس رویه و نوع ترمز هر مدل را از مشخصات همان صفحه بخوانید. وضعیت کف، سرعت حرکت، توزیع بار، دمای محیط و نیاز به توقف ایمن را هم بررسی کنید. ظرفیت اعلام‌شده در این کاتالوگ نمونه مربوط به هر چرخ است و ظرفیت کل شاسی باید با درنظرگرفتن توزیع نامتوازن بار و شرایط واقعی محاسبه و تأیید شود.",
      specifications: [
      ...
      features: [
        ...
        "صفحه نصب چهارپیچ برای اتصال به شاسی",
      ],
      faq: [
        {
          question: "آیا این مشخصات مبنای سفارش هستند؟",
        ...
        {
          question: "ترمز این چرخ چه چیزی را قفل می‌کند؟",
          answer:
            "در چرخ عکس‌برداری‌شده اهرم روی پایه گردان دیده می‌شود. قفل کامل معمولاً چرخ و گردش پایه را با هم متوقف می‌کند؛ نوع ترمز هر مدل نمونه را از جدول مشخصات همین صفحه بخوانید.",
        },
      ],
    }),
);
...
const levels = levelLengths.map((length, i) =>
  base("spirit-levels", i + 1, {
    ...
    longDescription:
      "یک تراز مناسب باید با طول سطح، فضای کار و دقت موردنیاز سازگار باشد. تراز عکس‌برداری‌شده بدنه جعبه‌ای، سه محفظه حباب و ضربه‌گیر انتهایی دارد. این خانواده نمونه، ترازهای بدنه آلومینیومی در طول‌های مختلف را معرفی می‌کند. دقت اعلام‌شده در کاتالوگ نمونه است و باید با سند سازنده تطبیق داده شود. پیش از شروع کار، سلامت بدنه و محفظه‌ها را بررسی کنید و صحت قرائت را با آزمون چرخش کنترل کنید.",
    specifications: [
    ...
    features: [
      ...
      "بدنه جعبه‌ای با محفظه‌های خوانا در تصویر خانواده",
    ],
    faq: [
      {
        question: "آیا این مشخصات مبنای سفارش هستند؟",
      ...
      {
        question: "دقت ۰٫۵ میلی‌متر بر متر یعنی چه؟",
        answer:
          "این مقدار نمونه است و معمولاً انحراف مجاز در هر متر طول را بیان می‌کند. سلامت بدنه و روش قرار دادن تراز روی نتیجه اثر دارند و باید با سند سازنده تطبیق داده شوند.",
      },
    ],
  }),
);
...
const abrasives = abrasiveData.map(
  ([diameter, thickness, workpiece, type, rpm], i) =>
    base("abrasives", i + 1, {
      ...
      longDescription:
        "صفحه را با توجه به جنس قطعه‌کار، نوع عملیات، قطر مجاز دستگاه و سرعت آن انتخاب کنید. تصویر خانواده صفحات الیافی با سوراخ مرکزی و نشان کانوکس را نشان می‌دهد؛ نوع عملیات هر مدل (برش یا ساب) را از مشخصات همان صفحه بخوانید، نه از شباهت ظاهری عکس. سرعت مجاز صفحه باید با سرعت دستگاه سازگار باشد و هرگز کمتر از آن نباشد. از صفحه برش برای ساب جانبی استفاده نکنید. محافظ دستگاه و تجهیزات حفاظت فردی باید مطابق دستورالعمل سازنده استفاده شوند. اطلاعات این مدل صرفاً نمونه است.",
      specifications: [
      ...
      features: [
        ...
        "سوراخ مرکزی برای نصب روی دستگاه سازگار",
      ],
      faq: [
        {
          question: "آیا این مشخصات مبنای سفارش هستند؟",
        ...
        {
          question: "صفحه برش را می‌توان برای ساب استفاده کرد؟",
          answer:
            "خیر، نباید. از صفحه برش برای ساب جانبی استفاده نکنید. نوع عملیات را از برچسب صفحه و دستورالعمل سازنده بخوانید.",
        },
      ],
    }),
);
const accessories = [
  base("accessories", 1, {
    ...
    longDescription:
      "برای حمل و نگهداری متر لیزری، کیف متناسب با ابعاد دستگاه انتخاب کنید. تصویر خانواده، کیف زیپ‌دار پارچه‌ای را در کنار بند نایلونی نشان می‌دهد؛ سازگاری ابعاد داخلی با مدل دستگاه باید پیش از سفارش بررسی شود. تصویر این محصول نمایشی است و تصویر مجموعه متعلقات برای معرفی خانواده محصول استفاده شده است.",
    specifications: [
    ...
    images: [
      {
        url: "/images/accessories.webp",
        alt: "کیف زیپ‌دار پارچه‌ای نگهداری متر لیزری کانوکس در کنار بند حمل نایلونی",
      },
    ],
  ...
  base("accessories", 2, {
    ...
    longDescription:
      "بند مچی، جایگزین نگهداری صحیح دستگاه نیست. تصویر خانواده بند نایلونی با سگک پلاستیکی را نشان می‌دهد که برای حمل کیف به‌کار می‌رود؛ محل اتصال روی دستگاه را جداگانه بررسی کنید. پیش از استفاده، سلامت بند و سازگاری محل اتصال را بررسی کنید. تصویر این محصول نمایشی است و تصویر مجموعه متعلقات برای معرفی خانواده محصول استفاده شده است.",
    specifications: [
    ...
    images: [
      {
        url: "/images/accessories.webp",
        alt: "بند نایلونی حمل کیف متر لیزری کانوکس در کنار کیف زیپ‌دار",
      },
    ],
    applications: ["construction", "equipment"],
    featured: false,
...
export const products: Product[] = catalog.map((p) => ({
  ...p,
  relatedProductIds: p.relatedProductIds.length
    ? p.relatedProductIds
    : catalog
